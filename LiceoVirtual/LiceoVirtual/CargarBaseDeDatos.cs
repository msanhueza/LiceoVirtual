...
public class CargarBaseDeDatos
{
	...
	private void cargarPreguntaRespuestaBD(){	
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="El organelo indicado con la flecha es", idImagen = 2130837539, nivel=1, tipoFragment="1-2-3"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="El organelo indicado con la flecha es", idImagen = 2130837547, nivel=1, tipoFragment="1-2"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="El organelo indicado con la flecha corresponde a", idImagen = 2130837552, nivel=1, tipoFragment="1-2"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="El organelo indicado con la flecha corresponde a", idImagen = 2130837553, nivel=1, tipoFragment="1-2"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="El organelo indicado con la flecha corresponde a", idImagen = 2130837554, nivel=1, tipoFragment="1-2-3"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="El organelo indicado con la flecha tiene como función", idImagen = 2130837555, nivel=1, tipoFragment="1-2-3"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="En la parte de la célula indicado con la flecha se realiza la función de", idImagen = 2130837556, nivel=1, tipoFragment="1-2-3"});
		...
		//arreglar imagen
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="¿Cuál de los siguientes organelos es propio de la célula vegetal?", idImagen = 2130837558, nivel=1, tipoFragment="1"});
		...
		preguntaSolucionAccion.insertUpdateData (new PreguntaSolucionBD{idPregunta=8, solucion="5", esSolucion=true});
		//arreglar imagen
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="¿En cuál de los siguientes organelos ocurre la replicación del ADN?", idImagen = 2130837540, nivel=1, tipoFragment="1"});
		...
		preguntaSolucionAccion.insertUpdateData (new PreguntaSolucionBD{idPregunta=9, solucion="4", esSolucion=true});
		//arreglar imagen
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="¿Cuál de los siguientes organelos utiliza CO2?", idImagen = 2130837541, nivel=1, tipoFragment="1"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="¿En cuál de los siguientes organelos se sintetizan la mayor cantidad de proteínas?", idImagen = -1, nivel=1, tipoFragment="1-2-3"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="¿En cuál de los siguientes organelos se realiza la respiración celular?", idImagen = -1, nivel=1, tipoFragment="1-2"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="La parte del microscopio indicada con la flecha corresponde a", idImagen = 2130837542, nivel=1, tipoFragment="1-2"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="La parte del microscopio indicada con la flecha corresponde a", idImagen = 2130837543, nivel=1, tipoFragment="1-2"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="¿A qué tejido corresponde la siguiente imagen?", idImagen = 2130837544, nivel=1, tipoFragment="1-2"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="Una de las diferencias fundamentales entre la célula vegetal y animal es que la primera presenta:", idImagen = -1, nivel=1, tipoFragment="1-2-3"});
		...
		//arreglar imagen
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="¿Cuál de las siguientes imágenes corresponde al Complejo de Golgi?", idImagen = 2130837546, nivel=1, tipoFragment="1"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="La parte del microscopio que se indica con la flecha es", idImagen = 2130837547, nivel=1, tipoFragment="1-2"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="El organelo indicado en la figura se encuentra en mayor proporción en", idImagen = 2130837548, nivel=1, tipoFragment="1-3"});
		...
		//arreglar imagen
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="¿Cuál de los siguientes organelos se encuentra en gran cantidad en las células del músculo esquelético?", idImagen = 2130837549, nivel=1, tipoFragment="1"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="En una célula del epitelio respiratorio que tiene como función la secreción de mucosidad para mantener húmeda la vía respiratoria debiera observarse una gran cantidad de", idImagen = -1, nivel=1, tipoFragment="1-2-3"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="En una célula de la corteza suprarenal que secreta glucocorticoides (hormona lipofílica) debiera observarse una gran cantidad de", idImagen = -1, nivel=1, tipoFragment="1-2-3"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="El órgano indicado con la flecha corresponde a:", idImagen = 123456, nivel=1, tipoFragment="1-2"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="En el tejido cerebral la célula que se encuentra en mayor proporción es", idImagen = -1, nivel=1, tipoFragment="1-2"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="Los glóbulos blancos son parte del tejido", idImagen = -1, nivel=1, tipoFragment="1-2"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="La siguiente imagen corresponde a", idImagen = 123456, nivel=1, tipoFragment="1-2-3"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="La proteína G que induce adenilato ciclasa que está formada por subunidades:", idImagen = -1, nivel=3, tipoFragment="1-3"});	
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="La proteína G, se activa por adición de:", idImagen = -1, nivel=3, tipoFragment="1-2"});	
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="La actividad quinasa se define como actividad:", idImagen = -1, nivel=3, tipoFragment="1-2"});	
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="La diferencia más radical entre señales hormonales y neuronales es:", idImagen = -1, nivel=3, tipoFragment="1-3"});	
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="Las uniones comunicantes en una membrana van a permitir la función:", idImagen = -1, nivel=3, tipoFragment="1-3"});	
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="El azúcar  que forma parte de los ácidos nucleicos, entre ellos el ADN es", idImagen = -1, nivel=4, tipoFragment="1-2"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="Las bases nitrogenadas que encontramos en el  ADN son:", idImagen = -1, nivel=4, tipoFragment="1-2-3"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="Un nucleótido está formado por:", idImagen = -1, nivel=4, tipoFragment="1-3"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="De acuerdo a lo que usted ha podido investigar sobre la estructura del ADN, ¿Cuál de las siguientes aseveraciones sería incorrecta?", idImagen = -1, nivel=4, tipoFragment="1-3"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="Una de las siguientes afirmaciones es falsa:", idImagen = -1, nivel=4, tipoFragment="1-3"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="El par de  nucleótidos que no  sirven de base para la información en ADN, sería:", idImagen = -1, nivel=4, tipoFragment="1-3"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="La meiosis se caracteriza fundamentalmente por:", idImagen = -1, nivel=4, tipoFragment="1-3"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="Con respecto al nucleosoma podemos anunciar las siguientes características, excepto:", idImagen = -1, nivel=4, tipoFragment="1-3"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="Los genes tienen como características excepto:", idImagen = -1, nivel=4, tipoFragment="1-3"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="El gen de la insulina se caracteriza por:", idImagen = -1, nivel=4, tipoFragment="1-3"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="Una enzima es un compuesto químico que se caracteriza por poseer:", idImagen = -1, nivel=4, tipoFragment="1-3"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="La energía de activación:", idImagen = -1, nivel=4, tipoFragment="1-3"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="Los azúcares forman parte de las moléculas que dan vida y entre ellos el más importante y destacado es el que compone el ADN, y sería:", idImagen = -1, nivel=4, tipoFragment="1-2"});
		...
		preguntaAccion.insertUpdateData (new PreguntaBD{ pregunta="A menudo el ARN debe replicarse en la fase S del ciclo celular. En ello podemos observar las siguientes características que la distinguen:", idImagen = -1, nivel=4, tipoFragment="1-2"});
